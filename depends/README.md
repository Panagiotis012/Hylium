...
Hylium Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Hylium Core

**When configuring Hylium Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Hylium Core:
...
variables will be set when generating the Hylium Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
