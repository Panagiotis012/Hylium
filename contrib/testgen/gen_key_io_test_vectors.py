#!/usr/bin/env python3
# Copyright (c) 2012-2022 The Hylium Core developers
...
bech32_templates = [
  ...
  ('hyl',   0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('hyl',   0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('hyl',   1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('hyl',   2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('thyl',  0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('thyl',  0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('thyl',  1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('thyl',  3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('thyl',  0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('thyl',  0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('thyl',  1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('thyl',  3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rhyl',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rhyl',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rhyl',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rhyl', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('thyl', 17, 32, Encoding.BECH32M, False, False, False),
  ('rhyl',  3,  1, Encoding.BECH32M, False, False, False),
  ('hyl',  15, 41, Encoding.BECH32M, False, False, False),
  ('thyl',  0, 16, Encoding.BECH32,  False, False, False),
  ('rhyl',  0, 32, Encoding.BECH32,  True,  False, False),
  ('hyl',   0, 16, Encoding.BECH32,  True,  False, False),
  ('thyl',  0, 32, Encoding.BECH32,  False, True,  False),
  ('rhyl',  0, 20, Encoding.BECH32,  False, False, True),
  ('hyl',   0, 20, Encoding.BECH32M, False, False, False),
  ('thyl',  0, 32, Encoding.BECH32M, False, False, False),
  ('rhyl',  0, 20, Encoding.BECH32M, False, False, False),
  ('hyl',   1, 32, Encoding.BECH32,  False, False, False),
  ('thyl',  2, 16, Encoding.BECH32,  False, False, False),
  ('rhyl', 16, 20, Encoding.BECH32,  False, False, False),
]
