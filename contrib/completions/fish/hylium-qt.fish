...
complete --command hylium-qt --no-files

# Extract options
function __fish_hyliumqt_get_options
...
complete \
    --command hylium-qt \
    --arguments "(__fish_hyliumqt_get_options --nofiles)"
