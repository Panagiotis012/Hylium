...
# Extract options
function __fish_hylium_tx_get_options
...
# Extract commands
function __fish_hylium_tx_get_commands
...
complete \
    --command hylium-tx \
    --condition "not __fish_hylium_seen_cmd (__fish_hylium_tx_get_commands --commandsonly)" \
    --arguments "(__fish_hylium_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command hylium-tx \
    --arguments "(__fish_hylium_tx_get_commands)" \
    --no-files
