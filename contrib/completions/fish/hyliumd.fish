...
complete --command hyliumd --no-files

# Extract options
function __fish_hyliumd_get_options
...
complete \
    --command hyliumd \
    --arguments "(__fish_hyliumd_get_options --nofiles)"
