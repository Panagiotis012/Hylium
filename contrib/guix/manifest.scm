...
(define* (make-hylium-cross-toolchain target
                                       #:key
...
desirable for building Hylium Core release binaries."
...
;; failure; see https://github.com/hylium/hylium/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-hylium-cross-toolchain target)))
