...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef HYLIUM_CHAINPARAMSSEEDS_H\n')
    g.write('#define HYLIUM_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the hylium network\n')
    ...
    g.write('#endif // HYLIUM_CHAINPARAMSSEEDS_H\n')
