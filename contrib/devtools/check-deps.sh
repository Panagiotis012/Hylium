...
declare -A LIBS
LIBS[cli]="libhylium_cli.a"
LIBS[common]="libhylium_common.a"
LIBS[consensus]="libhylium_consensus.a"
LIBS[crypto]="libhylium_crypto.a"
LIBS[node]="libhylium_node.a"
LIBS[util]="libhylium_util.a"
LIBS[wallet]="libhylium_wallet.a"
...
# https://github.com/hylium/hylium/issues/10102
