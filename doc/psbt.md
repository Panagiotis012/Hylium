# PSBT Howto for Hylium Core

Since Hylium Core 0.17, an RPC interface exists for Partially Signed Hylium
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/hylium/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Hylium transactions that are not fully signed
...
#### Multisig with multiple Hylium Core instances
