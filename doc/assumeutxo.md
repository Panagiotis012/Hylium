...
Assumeutxo is a feature that allows fast bootstrapping of a validating hyliumd
instance.
...
```
$ hylium-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ hylium-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
