...
Hylium Core version 0.19.1 is now available from:

  <https://hyliumcore.org/bin/hylium-core-0.19.1/>
...
From Hylium Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Hylium Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Hylium Core does not yet change appearance when
...
- #17488 fix "hyliumd already running" warnings on macOS (fanquake)
