Hylium-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hylium/files/Hylium/hylium-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Hylium
...
New/changed settings (command-line or hylium.conf file)
--------------------------------------------------------
