Hylium Core version 27.0 is now available from:

  <https://hyliumcore.org/bin/hylium-core-27.0/>
...
- libhyliumconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libhyliumkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Hylium Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Hylium Core would
