Hylium Core version *0.15.2* is now available from:

  <https://hyliumcore.org/bin/hylium-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in hylium-tx (TheBlueMatt)
