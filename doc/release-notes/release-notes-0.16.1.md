Hylium Core version 0.16.1 is now available from:

  <https://hyliumcore.org/bin/hylium-core-0.16.1/>
...
- #12843 `df38b13` Test starting hyliumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure hyliumd processes are cleaned up when tests end (sdaftuar)
