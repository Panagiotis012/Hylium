Hylium Core version 0.9.2.1 is now available from:

  https://hylium.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HYL to 0.01 HYL
...
- Fix "Start hylium on system login"
