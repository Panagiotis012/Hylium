Hylium Core version 0.9.4 is now available from:

  https://hylium.org/bin/0.9.4/
...
this update is incompatible with the Hylium system and could lead to consensus
forks.

Hylium Core released binaries from https://hylium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hylium/+archive/ubuntu/hylium
- A third-party or self-compiled Hylium Core

upgrade to Hylium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
