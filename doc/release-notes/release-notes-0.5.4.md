Hylium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hylium/files/Hylium/hylium-0.5.4/
...
http://gitorious.org/hylium/hyliumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Hylium-Qt notifications under Growl 1.3.
Increase required age of Hylium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHylium properly when installing Hylium-Qt over it. (Windows)
