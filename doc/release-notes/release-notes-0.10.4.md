Hylium Core version 0.10.4 is now available from:

  <https://hylium.org/bin/hylium-core-0.10.4/>
...
- #6953 `43c2789` Split hylium-tx into its own package
- #6953 `dfe0d4d` Include hylium-tx binary on Debian/Ubuntu
