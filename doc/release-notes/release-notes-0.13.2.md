Hylium Core version 0.13.2 is now available from:

  <https://hylium.org/bin/hylium-core-0.13.2/>
...
- #8908 `4a974b2` Update hylium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow hylium-tx to create v2 transactions (hyldrak)
