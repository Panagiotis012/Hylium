...
```sh
cmake --build build --target hyliumd hylium-cli
cmake --build build --target hylium-qt
cmake --build build --target bench_hylium
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:hylium/hylium.git
```
...
> e.g. github.com/hylium/hylium.git or for the GUI github.com/hylium-core/gui
