...
function(extract_strings output)
  ...
  file(STRINGS "hyliumstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *hylium_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"hylium-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/hyliumstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/hyliumstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/hylium_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/hylium_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/hylium_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/hylium_en.xlf" hylium_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" hylium_en "${hylium_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" hylium_en "${hylium_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/hylium_en.xlf" "${hylium_en}")
