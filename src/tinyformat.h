...
#include <algorithm>
#include <attributes.h> // Added for Hylium Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Hylium Core
#include <util/string.h> // Added for Hylium Core
...
// Added for Hylium Core. Similar to std::runtime_format from C++26.
...
// Added for Hylium Core. Wrapper for checking format strings at compile time.
