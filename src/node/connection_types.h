...
#ifndef HYLIUM_NODE_CONNECTION_TYPES_H
#define HYLIUM_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/hylium-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Hylium’s Peer-to-Peer Network")
...
#endif // HYLIUM_NODE_CONNECTION_TYPES_H
