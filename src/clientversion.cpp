...
// The <hylium-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
//
#define GIT_COMMIT_ID "41bf8f2d5eceaac72b98c1791f5fc368b3af90cb"
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/hylium/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Hylium Core copyright is not removed by accident
    if (copyright_devs.find("Hylium Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Hylium Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hylium/hylium>";
