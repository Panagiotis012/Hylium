...
#ifndef HYLIUM_POLICY_FEERATE_H
#define HYLIUM_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "HYL"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    HYL_KVB,      //!< Use HYL/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::HYL_KVB) const;
