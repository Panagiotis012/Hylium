...
#ifndef HYLIUM_TXMEMPOOL_H
#define HYLIUM_TXMEMPOOL_H
 ...
 * Hylium-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Hylium-specific parts of mempool
