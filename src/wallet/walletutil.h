// Copyright (c) 2017-2021 The Hylium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HYLIUM_WALLET_WALLETUTIL_H
#define HYLIUM_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! hylium from opening the wallet, thinking it was newly created, and
...
#endif // HYLIUM_WALLET_WALLETUTIL_H
