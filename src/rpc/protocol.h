...
#ifndef HYLIUM_RPC_PROTOCOL_H
#define HYLIUM_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in hyliumd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Hylium is not connected
