...
#ifndef HYLIUM_RPC_UTIL_H
#define HYLIUM_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting HYL/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1HYL/kvB.
 */
