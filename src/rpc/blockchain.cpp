...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (hylium-cli -rpcclienttimeout=0)",
                {
        ...
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
            {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The Hylium address (only if a well-defined address exists)"},
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (hylium-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
        ...
        RPCExamples{
            HelpExampleCli("scanblocks", "start '[\"addr(rhyl1q4u4nsgk6ug0sqz7r3rj9tykjxrsl0yy4jth83n)\"]' 300000") +
            HelpExampleCli("scanblocks", "start '[\"addr(rhyl1q4u4nsgk6ug0sqz7r3rj9tykjxrsl0yy4jth83n)\"]' 100 150 basic") +
            HelpExampleCli("scanblocks", "status") +
            HelpExampleRpc("scanblocks", "\"start\", [\"addr(rhyl1q4u4nsgk6ug0sqz7r3rj9tykjxrsl0yy4jth83n)\"], 300000") +
            HelpExampleRpc("scanblocks", "\"start\", [\"addr(rhyl1q4u4nsgk6ug0sqz7r3rj9tykjxrsl0yy4jth83n)\"], 100, 150, \"basic\"") +
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (hylium-cli -rpcclienttimeout=0)",
        {
        ...
        RPCExamples{
            HelpExampleCli("getdescriptoractivity", "'[\"000000000000000000001347062c12fded7c528943c8ce133987e2e2f5a840ee\"]' '[\"addr(hyl1qzl6nsgqzu89a66l50cvwapnkw5shh23zckejmp)\"]'")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    UniValue ret(UniValue::VOBJ);
    ...
    const std::function<void()>& interruption_point)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/hylium/hylium/pull/15606#discussion_r274479369
        //
        AssertLockHeld(::cs_main);
    ...
    const std::function<void()>& interruption_point)
{
    ...
    // See also https://github.com/hylium/hylium/issues/25675
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable hyliumd instance that is current with the network tip in a "
        ...
        "document (<https://github.com/hylium/hylium/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
