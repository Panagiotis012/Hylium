...
const std::string EXAMPLE_ADDRESS[2] = {"hyl1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", "hyl1q02ad21edsxd23d32dfgqqsz4vv4nmtfzuklhy3"};
...
CFeeRate ParseFeeRate(const UniValue& json)
{
    ...
    if (val >= COIN) throw JSONRPCError(RPC_INVALID_PARAMETER, "Fee rates larger than or equal to 1HYL/kvB are not accepted");
    return CFeeRate{val};
}
...
{
    return "> hylium-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleCliNamed(const std::string& methodname, const RPCArgList& args)
{
    std::string result = "> hylium-cli -named " + methodname;
