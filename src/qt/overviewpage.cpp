...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = HyliumUnits::formatWithUnit(unit, amount, true, HyliumUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    HyliumUnit unit{HyliumUnit::HYL};
...
{
    HyliumUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(HyliumUnits::formatWithPrivacy(unit, balances.balance, HyliumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(HyliumUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, HyliumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(HyliumUnits::formatWithPrivacy(unit, balances.immature_balance, HyliumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(HyliumUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, HyliumUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("HYL")
    updateDisplayUnit();
}
