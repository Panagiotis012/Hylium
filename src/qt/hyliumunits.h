...
#ifndef HYLIUM_QT_HYLIUMUNITS_H
#define HYLIUM_QT_HYLIUMUNITS_H
...
/** Hylium unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HyliumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HyliumUnits(QObject *parent);

    /** Hylium units.
      @note Source: https://en.hylium.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        HYL,
        mHYL,
