...
#ifndef HYLIUM_QT_HYLIUMGUI_H
#define HYLIUM_QT_HYLIUMGUI_H
...
/**
  Hylium GUI main class. This class represents the main window of the Hylium UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class HyliumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit HyliumGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~HyliumGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a hylium wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, HyliumUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Hylium Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(HyliumUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // HYLIUM_QT_HYLIUMGUI_H
