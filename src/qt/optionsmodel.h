...
#ifndef HYLIUM_QT_OPTIONSMODEL_H
#define HYLIUM_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Hylium client.
...
public:
    ...
    HyliumUnit getDisplayUnit() const { return m_display_hylium_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSHYLontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    HyliumUnit m_display_hylium_unit;
...
Q_SIGNALS:
    void displayUnitChanged(HyliumUnit unit);
...
#endif // HYLIUM_QT_OPTIONSMODEL_H
