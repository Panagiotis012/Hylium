...
//! Entry point for HyliumApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &HyliumApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for HyliumGUI tests.
void AppTests::guiTests(HyliumGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &HyliumGUI::consoleShown, this, &AppTests::consoleTests);
