...
{
    // Test regression https://github.com/hylium/hylium/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/hylium-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/hylium-core/gui/pull/568.
    // With fListen=false in ~/.config/Hylium/Hylium-Qt.conf and all else left as default,
    // hylium-qt should set both -listen and -listenonion to false and start successfully.
