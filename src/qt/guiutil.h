...
#ifndef HYLIUM_QT_GUIUTIL_H
#define HYLIUM_QT_GUIUTIL_H
...
/** Utility functions used by the Hylium Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "hylium:" URI into recipient object, return true on successful parsing
