...
#ifndef HYLIUM_QT_WALLETVIEW_H
#define HYLIUM_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a hylium wallet, and offers access to
