...
#ifndef HYLIUM_QT_RECEIVECOINSDIALOG_H
#define HYLIUM_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of hyliums */
...
#endif // HYLIUM_QT_RECEIVECOINSDIALOG_H
