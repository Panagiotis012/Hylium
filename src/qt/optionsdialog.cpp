      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->hyliumAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->hyliumAtStartup);
    ...
    ui->hyliumAtStartup->setToolTip(ui->hyliumAtStartup->toolTip().arg(CLIENT_NAME));
    ui->hyliumAtStartup->setText(ui->hyliumAtStartup->text().arg(CLIENT_NAME));

    ui->openHyliumConfButton->setToolTip(ui->openHyliumConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new HyliumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->hyliumAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSHYLontrols);
...
void OptionsDialog::on_openHyliumConfButton_clicked()
{
