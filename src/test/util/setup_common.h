...
#ifndef HYLIUM_TEST_UTIL_SETUP_COMMON_H
#define HYLIUM_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/hylium/hylium/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // HYLIUM_TEST_UTIL_SETUP_COMMON_H
