...
constexpr inline auto TEST_DIR_PATH_ELEMENT{"test_common hylium"}; // Includes a space to catch possible path escape issues.
    ...
    : TestingSetup{ChainType::REGTEST, opts}
{
...

    {
        ...
        assert(
            ...
            "2cbcea53a48ad2e56e59988982a9f61680121c2da2dd5b29fbf8d3a07e6b5cee");
    }
}
