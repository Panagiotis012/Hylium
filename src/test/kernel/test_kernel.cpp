...
#include <kernel/hyliumkernel_wrapper.h>

#define BOOST_TEST_MODULE Hylium Kernel Test Suite
...
BOOST_AUTO_TEST_CASE(hylk_transaction_tests)
{
...
BOOST_AUTO_TEST_CASE(hylk_script_pubkey)
{
...
BOOST_AUTO_TEST_CASE(hylk_transaction_output)
{
...
BOOST_AUTO_TEST_CASE(hylk_transaction_input)
{
...
BOOST_AUTO_TEST_CASE(hylk_script_verify_tests)
{
...
{
    hylk_LoggingOptions logging_options = {
        .log_timestamps = true,
...
BOOST_AUTO_TEST_CASE(hylk_context_tests)
{
...
BOOST_AUTO_TEST_CASE(hylk_block)
{
...
BOOST_AUTO_TEST_CASE(hylk_chainman_tests)
{
    Logger logger{std::make_unique<TestLog>()};
    auto test_directory{TestDirectory{"chainman_test_hylium_kernel"}};
...
BOOST_AUTO_TEST_CASE(hylk_chainman_mainnet_tests)
{
    auto test_directory{TestDirectory{"mainnet_test_hylium_kernel"}};
...
BOOST_AUTO_TEST_CASE(hylk_block_hash_tests)
{
...
BOOST_AUTO_TEST_CASE(hylk_block_tree_entry_tests)
{
    auto test_directory{TestDirectory{"block_tree_entry_test_hylium_kernel"}};
    auto notifications{std::make_shared<TestKernelNotifications>()};
...
BOOST_AUTO_TEST_CASE(hylk_chainman_in_memory_tests)
{
    auto in_memory_test_directory{TestDirectory{"in-memory_test_hylium_kernel"}};
...
BOOST_AUTO_TEST_CASE(hylk_chainman_regtest_tests)
{
    auto test_directory{TestDirectory{"regtest_test_hylium_kernel"}};
