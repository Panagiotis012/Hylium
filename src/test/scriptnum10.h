...
#ifndef HYLIUM_TEST_SCRIPTNUM10_H
#define HYLIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hylium Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // HYLIUM_TEST_SCRIPTNUM10_H
