// Copyright (c) 2012-present The Hylium Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.hyliumcore.org", "www.hyliumcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.hyliumcore.org]", "www.hyliumcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.hyliumcore.org:80", "www.hyliumcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.hyliumcore.org]:80", "www.hyliumcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.hyliumcore.org:65536", "www.hyliumcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.hyliumcore.org:0", "www.hyliumcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.hyliumcore.org:", "www.hyliumcore.org:", 0, false));
}
