...
#ifndef HYLIUM_IPC_CAPNP_COMMON_TYPES_H
#define HYLIUM_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between hylium processes.
...
//! Functions to serialize / deserialize common hylium types.
namespace mp {
...
#endif // HYLIUM_IPC_CAPNP_COMMON_TYPES_H
