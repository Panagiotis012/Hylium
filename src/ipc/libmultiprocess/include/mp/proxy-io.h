...
extern thread_local ThreadContext g_thread_context; // NOLINT(hylium-nontrivial-threadlocal)
// Silence nonstandard hylium tidy error "Variable with non-trivial destructor
