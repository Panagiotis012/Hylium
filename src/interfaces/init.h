...
#ifndef HYLIUM_INTERFACES_INIT_H
#define HYLIUM_INTERFACES_INIT_H
...
//! (hylium-gui, hylium-node, hylium-wallet, hyliumd, hylium-qt) and each
...
#endif // HYLIUM_INTERFACES_INIT_H
