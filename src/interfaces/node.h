...
#ifndef HYLIUM_INTERFACES_NODE_H
#define HYLIUM_INTERFACES_NODE_H
...
//! Top-level interface for a hylium node (hyliumd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or hylium.conf.
...
#endif // HYLIUM_INTERFACES_NODE_H
