...
#ifndef HYLIUM_COMMON_SIGNMESSAGE_H
#define HYLIUM_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's hylium address, it must refer to a public key.
...
#endif // HYLIUM_COMMON_SIGNMESSAGE_H
