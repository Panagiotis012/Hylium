...
#ifndef HYLIUM_COMMON_ARGS_H
#define HYLIUM_COMMON_ARGS_H
...
extern const char * const HYLIUM_CONF_FILENAME;
extern const char * const HYLIUM_SETTINGS_FILENAME;
