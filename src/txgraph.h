...
#ifndef HYLIUM_TXGRAPH_H
#define HYLIUM_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvinghylium.org/t/introduction-to-cluster-linearization/1032
 *
