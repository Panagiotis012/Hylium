...
#ifndef HYLIUM_TXREQUEST_H
#define HYLIUM_TXREQUEST_H
 ...
 *   specific transaction. See https://hyliumcore.org/en/2024/07/03/disclose_already_asked_for.
 */
