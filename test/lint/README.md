...
```sh
DOCKER_BUILDKIT=1 docker build --platform=linux --tag=hylium-linter --file="./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/hylium -it hylium-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/hylium-core/crc32c-subtree.git (branch hylium-fork)
* for `src/crypto/ctaes`: https://github.com/hylium-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/hylium-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/hylium-core/leveldb-subtree.git (branch hylium-fork)
* for `src/minisketch`: https://github.com/hylium-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/hylium-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/hylium-core/secp256k1.git
```
