...
class TransactionTimeRescanTest(HyliumTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine HYL and create transactions
        ...
        # generate some hyl to create transactions and check blockcount
        ...
        # send 10 hyl to user's first watch-only address
        self.log.info('Send 10 hyl to user')
        ...
        # send 5 hyl to our second watch-only address
        self.log.info('Send 5 hyl to user')
        ...
        # send 1 hyl to our third watch-only address
        self.log.info('Send 1 hyl to user')
