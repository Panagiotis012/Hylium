...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The hyliumd node closes feeler connections as soon as a version
...
class P2PAddConnections(HyliumTestFramework):
    ...
    def run_test(self):
        ...
        # hyliumd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that hyliumd sends its own version prior to processing
