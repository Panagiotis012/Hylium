...
By default, hyliumd will dump mempool on shutdown and
...
class MempoolPersistTest(HyliumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent hyliumd from writing mempool.dat to disk. Verify that `savemempool` fails")
