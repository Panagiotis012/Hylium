...
Verify that a hyliumd node can use an external signer command
...
class WalletSignerTest(HyliumTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "rhyl1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th6czvqaz")
        ...
        assert_equal(address4, "rhyl1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62msewyypz")
        ...
        assert_equal(address_fail, "rhyl1ql7zg7ukh3dwr25ex2zn9jse926f27xy2dxdw33")
