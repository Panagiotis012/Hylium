...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HyliumTestFramework
    pass


class ExampleTest(HyliumTestFramework):
    # Each functional test is a subclass of the HyliumTestFramework class.
    ...
    def custom_method(self):
        ...
        HyliumTestFramework class so other tests can use it."""
