...
class DeriveaddressesTest(HyliumTestFramework):
    ...
    def run_test(self):
        ...
        address = "rhyl1qjqmxmkpmxt80xz4y3746zgt0q3u3ferrw3y3h7"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["rhyl1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq23vrhw", "rhyl1qpgptk2gvshyl0s9lqshsmx932l9ccsv29sj982"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "rhyl1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq23vrhw", "rhyl1qpgptk2gvshyl0s9lqshsmx932l9ccsv29sj982"])
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), [["rhyl1q7c8mdmdktrzs8xgpjmqw90tjn65j5a3ydtvjte", "rhyl1qs6n37uzu0v0qfzf0r0csm0dwa7prc0v5re4p79"], ["rhyl1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq23vrhw", "rhyl1qpgptk2gvshyl0s9lqshsmx932l9ccsv29sj982"]])
        ...
        # Before #26275, hyliumd would crash when deriveaddresses was
        # called with derivation index 2147483647, which is the maximum
        # positive value of a signed int32, and - currently - the
        # maximum value that the deriveaddresses hylium RPC call
        # accepts as derivation index.
        assert_equal(self.nodes[0].deriveaddresses(descsum_create("wpkh(tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK/1/1/*)"), [2147483647, 2147483647]), ["rhyl1qtzs23vgzpreks5gtygwxf8tv5rldxvvsmdcyvz"])
