...
class HyliumChainstateTest(HyliumTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_hylium_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing hylium-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    HyliumChainstateTest(__file__).main()
