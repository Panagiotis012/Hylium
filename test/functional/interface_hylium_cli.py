#!/usr/bin/env python3
# Copyright (c) 2017-2022 The Hylium Core developers
...
# The block reward of coinbaseoutput.nValue (50) HYL/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 HYL/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"hylium-cli -h\" for help or \"hylium-cli listwallets\" to see "
...
class TestHyliumCli(HyliumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `hylium-cli getblockchaininfo`")
        ...
        # Prevent hylium-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and hylium-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and hylium-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (HYL/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (HYL/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 HYL) to the default wallet.
            ...
            # Test hylium-cli -generate with -rpcwallet in multiwallet mode.
