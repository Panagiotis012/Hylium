...
class TestShell:
    """Wrapper Class for HyliumTestFramework.

    The TestShell class extends the HyliumTestFramework
    ...
    class __TestShell(HyliumTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by HyliumTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # HyliumTestFramework instances are supposed to be constructed with the path
