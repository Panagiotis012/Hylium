...
class WalletLabelsTest(HyliumTestFramework):
    ...
    def test_label_named_parameter_handling(self):
        ...
        self.log.info("Test hylium-cli -named passes parameter containing '=' by position if it does not specify a known parameter name and is in a string position")
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Hyliums
        ...
        BECH32_VALID = {
            '✔️_VER15_PROG40': 'rhyl10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzhzx2a',
            '✔️_VER16_PROG03': 'rhyl1sqqqqqpmymam',
            '✔️_VER16_PROB02': 'rhyl1sqqqq6h6twy',
        }
        BECH32_INVALID = {
