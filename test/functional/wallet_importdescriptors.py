#!/usr/bin/env python3
# Copyright (c) 2019-2022 The Hylium Core developers
...
class ImportDescriptorsTest(HyliumTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["rhyl1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju70uxwje", "rhyl1qfqeppuvj0ww98r6qghmdkj70tv8qpchega32jd"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'rhyl1qtmp74ayg7p24uslctssvjm06q5phz4yrecppfx', # m/0'/0'/0
            'rhyl1q8vprchan07gzagd5e6v9wd7azyucksq2eu8nvd', # m/0'/0'/1
            'rhyl1qtuqdtha7zmqgcrr26n2rqxztv5y8rafj7px49k', # m/0'/0'/2
            'rhyl1qau64272ymawq26t90md6an0ps99qkrsetrzn09', # m/0'/0'/3
            'rhyl1qsg97266hrh6cpmutqen8s4s962aryy77d9kqj9', # m/0'/0'/4
        ]
        ...
        assert_equal(addr, 'rhyl1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqx0rr9h') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32') # uses change 0
        assert_equal(change_addr, 'rhyl1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnsgz58xf') # Derived at m/84'/1'/0'/0
        ...
        assert_equal(addr, 'rhyl1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqld6cz4') # Derived at m/84'/0'/0'/1
        change_addr = wmulti_pub.getrawchangeaddress('bech32') # uses change 2
        assert_equal(change_addr, 'rhyl1qp6j3jw8yetefte7kw6v5pc89rkgakzy98p6gf7ayslaveaxqyjusle4nwg') # Derived at m/84'/1'/0'/2
