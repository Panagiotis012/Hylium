...
class TxnMallTest(HyliumTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 HYL:
        ...
        # First: use raw transaction API to send 1240 HYL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 HYL coin each
        ...
        # Node0's balance should be starting balance, plus 50HYL for another
        ...
        # Node0's total balance should be starting balance, plus 100HYL for
