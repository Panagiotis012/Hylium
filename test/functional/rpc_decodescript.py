#!/usr/bin/env python3
# Copyright (c) 2015-present The Hylium Core developers
...
class DecodeScriptTest(HyliumTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('rhyl1pfeesuaf2pv', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        # Sourced from https://github.com/hylium/hylium/pull/27037#issuecomment-1416151907.
        ...
        assert res["segwit"]["desc"] == "addr(rhyl1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xsq3fwav)#9p3q328s"
